...
{
    _row = indexPath.row;
    [self performSegueWithIdentifier:@"detailFAQ" sender:self];
}

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqualToString:@"detailFAQ"])
    {
        FAQDetailViewController *detailVC = segue.destinationViewController;
        detailVC.row = _row;
    }
}
